...
/**
 * This class is a source of reactive streams used in this class.
 * @author Akshay-singh
 */
public class ReactiveSource{
   ...
   /* public static Flux<?> numbers(){
        return Flux.just(12,34,56);
    }

    public static Mono<?> characters(){
        return Mono.just("Akshay");
    }*/
}
